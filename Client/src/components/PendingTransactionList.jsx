              ...
              <div className="bg-neutral-800 rounded-xl p-4 flex flex-col">
                {groupItems.length === 0 ? (
                  ...
                  groupItems
                    ...
                    .map((item) => (
                      <div key={item.id} className="py-2 flex justify-between items-start text-sm cursor-pointer border-b border-neutral-700 last:border-b-0" onClick={() => setSelectedItem({ groupId: group.id, itemId: item.id })}>
                ...
                <button onClick={() => setAddItemGroupId(group.id)} className="text-white-400 hover:text-yellow-300 text-sm mt-3 flex items-center gap-2">
